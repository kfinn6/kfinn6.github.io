...
export const menuItems = [
  ...
  { name: "Architecture", path: "/architecture/", exact: true, icon: "building" },
  { name: "Photography", path: "/photography/", exact: false, icon: "photo" },
  { name: "Travel", path: "/travel/", exact: false, icon: "paper plane" },
];
